...
import and5.abrar.mvvmcountry.model.GetCountryItem
...
class AdapterCountry(private val listCountry: List<GetCountryItemItem>):RecyclerView.Adapter<AdapterCountry.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.btn_fav.setOnClickListener {
            ...
            GlobalScope.async {
                val result = mDb?.favoriteDao()?.insertFavorite(Favorite(
                    null,
                    data.name,
